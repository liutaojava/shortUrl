...
public class ShortController extends BaseController {
    ...
    public Object info(Long id) {
        ...
        ShortInfoDTO shortInfoDTO = new ShortInfoDTO();
        PropertUtil.copyPropertys(shorter, shortInfoDTO);
        shortInfoDTO.setIdStr(shortInfoDTO.getId() + "");
        return ResultCode.E_200_SUCCESS.toMsgEntity(shortInfoDTO);
    }
